...
class PansumanHTML {
    ...
    function getHastaList($day, $rows) {
  ...
  <li<?php echo $day == 1 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=1">Pazartesi</a></li>
  <li<?php echo $day == 2 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=2">Salı</a></li>
  <li<?php echo $day == 3 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=3">Çarşamba</a></li>
  <li<?php echo $day == 4 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=4">Perşembe</a></li>
  <li<?php echo $day == 5 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=5">Cuma</a></li>
  <li<?php echo $day == 6 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=6">Cumartesi</a></li>
  <li<?php echo $day == 0 ? ' class="active"':'';?>><a href="index.php?option=admin&bolum=pansuman&day=0">Pazar</a></li>
</ul>
    </div>
    </div>
    </div>

...
class IlceHTML {
	...
	<div class="panel-heading"><h4><i class="fa-solid fa-bacterium"></i> Yönetim Paneli - Hastalık Kategorisi <?php echo $row->id ? 'Düzenle' : 'Ekle';?></h4>
	</div>
...
<div class="row">
<div class="col-sm-3">
<label for="name">Hastalık Kategori Adı:</label></div>
<div class="col-sm-9"><input type="text" id="name" name="name" class="form-control" value="<?php echo $row->name;?>" required></div>
</div>

<input type="hidden" name="option" value="admin" />
<input type="hidden" name="bolum" value="hastaliklarcat" />
...
<?php
	...
	static function getIlceList($rows, $pageNav) {
        ...
        <form action="index.php" method="post" name="adminForm" role="form">
		<div class="panel panel-default">
	<div class="panel-heading"><h4><i class="fa-solid fa-bacterium"></i> Yönetim Paneli - Hastalık Kategorileri</h4></div>
	<div class="panel-body">
    
<div class="form-group">
<div class="btn-group">
<input type="button" name="button" value="Yeni Kategori Ekle" onclick="javascript:submitbutton('add');" class="btn btn-primary" />
...
<td><a href="index.php?option=admin&bolum=hastaliklarcat&task=editx&id=<?php echo $row->id;?>"><?php echo $row->name;?></a></td>
</tr>
<?php
$t = 1 - $t;
}
...
<?php 
$link = 'index.php?option=admin&bolum=hastaliklarcat';

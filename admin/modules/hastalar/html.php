...
?>
    ...
    <div class="col-xs-9"><h4><i class="fa-solid fa-file-lines"></i> Hasta Bilgileri:  <span style="color:<?php echo $hasta->cinsiyet == 'E' ? 'blue':'#f5070f';?>"><?php echo $hasta->isim." ".$hasta->soyisim;?></span> <sub>(<?php echo $hasta->anneAdi ? $hasta->anneAdi:'';?>/<?php echo $hasta->babaAdi ? $hasta->babaAdi:'';?>)</sub> <?php echo $hasta->pasif ? '('.$pasifmi[$hasta->pasifnedeni].')' : '' ;?></div>
...
<div class="form-group row">
<div class="col-sm-4"><label for="coords">Koordinatlar:</label></div>
<div class="col-sm-4"><span><?php echo $hasta->coords;?></span></div>
<div class="col-sm-4"><a href="#" data-toggle="modal" data-target="#changecoords" class="btn btn-info btn-xs">Adres Konumu Gir</a> <a href="#" data-toggle="modal" data-target="#konumbul" class="btn btn-warning btn-xs">Adres Konumu Bul</a></span></div>
</div>

 <div class="form-group row">
<div class="col-sm-4"><label for="kayittarihi">Kayıt Tarihi:</label></div>
<div class="col-sm-8"><?php echo $hasta->kayityili;?> / <?php echo $aylar[$hasta->kayitay];?></div>
</div>
...
<div class="col-sm-8"><?php echo $bagimli[$hasta->bagimlilik];?></div>
</div>
...
<div class="col-sm-8"><a href="index.php?option=admin&bolum=izlemler&task=izlemgetir&tc=<?php echo $hasta->tckimlik;?>"><span class="label label-warning"><?php echo $hasta->toplamizlem;?> İzlem</span></a></div>
</div>
...
?>
 <div class="form-group row">
<div class="col-sm-4"><label for="pasiftarihi">Pasif Tarihi:</label></div>
<div class="col-sm-8"><?php echo tarihCevir($hasta->pasiftarihi, 1);?></div>
</div>

 <div class="form-group row">
<div class="col-sm-4"><label for="pasifnedeni">Pasif Edilme Nedeni:</label></div>
<div class="col-sm-8"><?php echo $pasifmi[$hasta->pasifnedeni];?></div>
</div>
<?php
}
?>
...
<ul class="nav nav-pills">
  <li class="active"><a data-toggle="pill" href="#geneltab"><strong>Genel</strong></a></li>
...
<td class="col-xs-6"><?php echo $hasta->gecici ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=gecici&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=gecici&secim=1">Hayır</a>';?></td>
</tr>
<tr>
<th>Nazogastrik Takılı:</th>
<td><?php echo $hasta->ng ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=ng&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=ng&secim=1">Hayır</a>';?></td>
</tr>
<tr>
<th>PEG Takılı:</th>
<td><?php echo $hasta->peg ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=peg&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=peg&secim=1">Hayır</a>';?></td>
</tr>
<tr>
<th>Port Takılı:</th>
<td><?php echo $hasta->port ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=port&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=port&secim=1">Hayır</a>';?></td>
</tr>
<tr>
<th>Oksijen Bağımlı:</th>
<td><?php echo $hasta->o2bagimli ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=o2bagimli&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=o2bagimli&secim=1">Hayır</a>';?></td>
</tr>
<tr>
<th>Ventilatör Takılı:</th>
<td><?php echo $hasta->ventilator ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=ventilator&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=ventilator&secim=1">Hayır</a>';?></td>
</tr>
<tr>
<th>Kolostomi Takılı:</th>
<td><?php echo $hasta->kolostomi ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=kolostomi&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=kolostomi&secim=1">Hayır</a>';?></td>
</tr>
</table>           
  </div>
...
<td><?php echo $hasta->yatak ? '<strong><a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=yatak&secim=0">Evet</a></strong>': '<a href="index.php?option=admin&bolum=hastalar&task=change&id='.$hasta->id.'&ozellik=yatak&secim=1">Hayır</a>';?></td>
</tr>
</table>
  </div> 
...
<a href="index.php?option=admin&bolum=hastalar&task=edit&id=<?php echo $hasta->id;?>" class="btn btn-warning">Detaylı Düzenle</a>
...
<a href="index.php?option=admin&bolum=hastailacrapor&id=<?php echo $hasta->id;?>" class="btn btn-primary">Hastalık Rapor Bilgileri</a>
</div>
    </div>
    <div class="col-xs-6">
   <div class="form-group btn-group">
...
<div class="col-sm-6"><input id="isim" type="text" name="isim" class="form-control" value="<?php echo $hasta->isim;?>" required></div>
</div>

<div class="form-group row">
<div class="col-sm-6"><label for="soyisim">Hastanın Soyadı:</label></div>
<div class="col-sm-6"><input type="text" id="soyisim" name="soyisim" class="form-control" value="<?php echo $hasta->soyisim;?>" required></div>
</div>
...
<input data-date-format="dd.mm.yyyy" type='text' placeholder="GG.AA.YYYY" data-format="dd.dd.dddd" class="form-control bfh-phone" id="dogumtarihi" name="dogumtarihi" value="<?php echo $hasta->dtarihi;?>" required>
...
<div class="col-sm-6"><input type="text" id="anneAdi" name="anneAdi" class="form-control" placeholder="Anne Adı" value="<?php echo $hasta->anneAdi;?>"></div>
</div>

<div class="form-group row">
<div class="col-sm-6"><label for="babaAdi">Baba Adı:</label></div>
<div class="col-sm-6"><input type="text" id="babaAdi" name="babaAdi" class="form-control" placeholder="Baba Adı" value="<?php echo $hasta->babaAdi;?>"></div>
</div>

<div class="form-group row">
<div class="col-sm-6"><label for="boy">Hastanın Boyu:</label></div>
<div class="col-sm-6"><input type="text" id="boy" name="boy" class="form-control bfh-phone" data-format="d.dd" placeholder="0.00" value="<?php echo $hasta->boy;?>"></div>
</div>

<div class="form-group row">
<div class="col-sm-6"><label for="kilo">Hastanın Kilosu:</label></div>
<div class="col-sm-6"><input type="text" id="kilo" name="kilo" class="form-control bfh-phone" data-format="ddd" placeholder="000" value="<?php echo $hasta->kilo;?>"></div>
</div>
...
<div class="form-group row">
<div class="col-sm-6"><label for="coords">Koordinatlar:</label></div>
<div class="col-sm-6"><input name="coords" id="coords" type="text" class="form-control" value="<?php echo $hasta->coords;?>" /></div>
...
<div class="col-sm-6"><input type="text" id="telefon1" name="ceptel1" class="form-control bfh-phone" data-format="d (ddd) ddd dd dd" placeholder="0 (000) 000 00 00" value="<?php echo $hasta->ceptel1;?>"></div>
</div>

<div class="form-group row">
<div class="col-sm-6"><label for="telefon2">Telefon Numarası 2:</label></div>
<div class="col-sm-6"><input type="text" id="telefon2" name="ceptel2" class="form-control bfh-phone" data-format="d (ddd) ddd dd dd" placeholder="0 (000) 000 00 00" value="<?php echo $hasta->ceptel2;?>"></div>
</div>
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary">Kaydet</button>
...
<!-- konum bulma modal -->
<form action="index.php" data-toggle="validator" method="post" role="form" novalidate>
<div id="konumbul" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Konum Bulma Ekranı: <?php echo $hasta->isim." ".$hasta->soyisim;?></h4>
      </div>
      <div class="modal-body">
      <iframe id="iframe1" height="500px" width="100%" src="./konumbul.php?uid=<?php echo $hasta->id;?>" name="iframe_modal"></iframe>
      </div>
      <div class="modal-footer">
      <a href="#" data-toggle="modal" data-target="#changecoords" class="btn btn-info">Adres Konumu Gir</a>
        <button type="button" class="btn btn-default" data-dismiss="modal">Kapat</button>
      </div>
...
<input type="hidden" name="option" value="admin">
<input type="hidden" name="bolum" value="hastalar">
<input type="hidden" name="task" value="savecoords">
<input type="hidden" name="id" value="<?php echo $hasta->id;?>">
</form>
<!-- konum bulma modal -->              
<!-- koordinat değiştirme modal -->
<form action="index.php" data-toggle="validator" method="post" role="form" novalidate>
<div id="changecoords" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Adres Koordinat Bilgileri: <?php echo $hasta->isim." ".$hasta->soyisim;?></h4>
      </div>
      <div class="modal-body">
      
<div class="form-group row">
<div class="col-sm-6"><label for="coords">Koordinatlar:</label></div>
<div class="col-sm-6"><input type="text" id="coords" name="coords" class="form-control" value="<?php echo $hasta->coords;?>"></div>
</div>
...
<input data-date-format="dd.mm.yyyy" type='text' placeholder="GG.AA.YYYY" class="form-control" id="pasiftarihi" name="pasiftarihi" value="<?php echo $hasta->pasiftarihi ? tarihCevir($hasta->pasiftarihi, 1) : '';?>" />
<span class="input-group-addon">
<span class="glyphicon glyphicon-calendar"></span>
</span>
</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <tr id="pansumancheck" style="display:none">  <!-- sondacheck --> 
...
<div class="col-sm-6"><input type="text" data-minlength="11" maxlength="11" id="tckimlik" name="tckimlik" class="form-control" value="<?php echo $row->tckimlik;?>" autocomplete="off" required>
<?php if (!$row->id) { ?>
<span id="sonuc"></span>
<?php } ?>
</div>
...
<div class="form-group row">
<div class="col-sm-6"><label for="boy">Hastanın Boyu:</label></div>
<div class="col-sm-6"><input type="text" id="boy" name="boy" class="form-control bfh-phone" data-format="d.dd" placeholder="0.00" value="<?php echo $row->boy;?>" autocomplete="off"></div>
</div>

<div class="form-group row">
<div class="col-sm-6"><label for="kilo">Hastanın Kilosu:</label></div>
<div class="col-sm-6"><input type="text" id="kilo" name="kilo" class="form-control bfh-phone" data-format="ddd" placeholder="000" value="<?php echo $row->kilo;?>" autocomplete="off"></div>
</div>
...
<div class="form-group row">
<div class="col-sm-6"><label for="telefon1">Telefon Numarası 1:</label></div>
<div class="col-sm-6"><input type="text" id="telefon1" name="ceptel1" class="form-control bfh-phone" data-format="d (ddd) ddd dd dd" placeholder="0 (000) 000 00 00" value="<?php echo $row->ceptel1;?>" autocomplete="off"></div>
</div>
...
<div class="form-group row">
<div class="col-sm-6"><label for="coords">Koordinatlar:</label></div>
<div class="col-sm-6"><input name="coords" id="coords" type="text" class="form-control" value="<?php echo $row->coords;?>" autocomplete="off" /></div>
...
<h5 class="collapsed"><strong><?php echo $row->id ? 'Seçilmiş Hastalıklar':'Sık Kullanılanlar';?></strong></h5>
</div>
</span>
...
<div class="col-sm-6"><input type="text" id="sokakadi" name="sokakadi" class="form-control" value="" autocomplete="off" required></div>
</div>
...
<div class="form-group row">
<div class="col-sm-6"><label for="kapino">Kapı No:</label></div>
<div class="col-sm-6"><input type="text" id="kapino" name="kapino" class="form-control" value="" autocomplete="off" required></div>
</div>
...
<?php
    ...
    function getHastaList($baslangictarih, $bitistarih, $rows, $pageNav, $search, $ilce, $mahalle, $sokak, $kapino, $kayityili, $kayitay, $cinsiyet, $bagimlilik, $ozellik, $pasif, $ordering, $lists) {
...
<div class="form-group">
<label for="pasif">Dosya Türü</label>
<?php echo $lists['pasif'];?>
</div>

<div class="form-group">
<label for="pasif">Yaş Aralığı</label>
<div class="input-group input-range">
<input class="form-control" maxlength="3" type="text" name="baslangictarih" value="<?php echo $baslangictarih;?>" autocomplete="off">

<div class="input-group-addon">ile</div>

<input class="form-control" maxlength="3" type="text" name="bitistarih" value="<?php echo $bitistarih;?>" autocomplete="off">
...
<div class="form-group">
<label for="ozellik">Özelliğine Göre Hastalar</label>
...
<div class="panel-heading">
<div class="row">
    <div class="col-xs-11"><h4><i class="fa-solid fa-person-cane"></i> Tüm Hasta Listesi</h4></div>
    ...
    <th scope="col">
      <div>
     <a href="#" data-toggle="tooltip" title="Planlı İzlem Sayısı">#</a> 
    </div>  
    </th>   
      <th scope="col">
      <div>
  ...
  <?php 
   foreach($rows as $row) {
      ...
      <td scope="row"><span data-toggle="tooltip" title="<?php echo $row->totalplanli;?> Planlı İzlem" class="label label-<?php echo $row->totalplanli ? 'info':'warning';?>"><a href="index.php?option=admin&bolum=izlemler&task=pizlemgetir&tc=<?php echo $row->tckimlik;?>"><?php echo $row->totalplanli;?></a></span></td>
      <th scope="row">
       <div class="dropdown">
  ...
  <li><a href="index.php?option=admin&bolum=hastalar&task=show&id=<?php echo $row->id;?>">Bilgileri Göster</a></li>
    ...
    <li><a href="index.php?option=admin&bolum=izlemler&task=hedit&tc=<?php echo $row->tckimlik;?>">Yeni İzlem Gir</a></li>
      ...
      <td><?php echo $pasifmi[$row->pasifnedeni];?></td>
      <?php } ?>
      </tr>
 <?php 

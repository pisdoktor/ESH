...
<div class="panel panel-default">
        ...
        <div class="row">
    <div class="col-xs-11"><h4><i class="fa-solid fa-stethoscope"></i> İzlem Listesi: <a href="index.php?option=admin&bolum=hastalar&task=show&id=<?php echo $hasta->id;?>"><?php echo $hasta->isim.' '.$hasta->soyisim;?></a></h4></div>
...
<input type="hidden" name="task" value="" />
    ...
    <div class="panel-heading">
     <div class="row">
        <div class="col-xs-3"><h4><i class="fa-solid fa-receipt"></i> Tüm Planlanan İzlemler</h4></div>
        <div class="col-xs-8">
        <div class="form-group row">      
...
<div class="input-group-btn"><button class="btn btn-info" type="submit"><i class="glyphicon glyphicon-search"></i></button></div>
</div>
    </div>
    ...
    <div class="col-sm-1">
    <input type="button" name="button" value="Kayıtları Getir" onclick="javascript:submitbutton('list');" class="btn btn-info"  />
    </div>
  ...
  <th scope="col">Planlanma Tarihi
       <span><a href="<?php echo $link;?>&ordering=i.izlemtarihi-DESC">▲</a></span>
  <span><a href="<?php echo $link;?>&ordering=i.izlemtarihi-ASC">▼</a></span>
  </th>
      <th scope="col">Yapılacak İzlem Tarihi
       <span><a href="<?php echo $link;?>&ordering=i.planlanantarih-DESC">▲</a></span>
  <span><a href="<?php echo $link;?>&ordering=i.planlanantarih-ASC">▼</a></span>
  </th>
      <th scope="col">Yapılacak İşlem
      <span><a href="<?php echo $link;?>&ordering=i.yapilacak-DESC">▲</a></span>
  <span><a href="<?php echo $link;?>&ordering=i.yapilacak-ASC">▼</a></span>
      </th>
    </tr>
    </thead>
    <tbody>
  ...
  <ul class="dropdown-menu">
    ...
    <li class="divider"></li>    
    <li><a href="index.php?option=admin&bolum=pizlemler&task=edit&id=<?php echo $row->id;?>">İzlemi Düzenle</a></li>
    <li><a href="index.php?option=admin&bolum=pizlemler&task=delete&id=<?php echo $row->id;?>">İzlemi Sil</a></li>
  </ul>
</div> 
      </th>
      <td><a href="index.php?option=admin&bolum=izlemler&task=edit&id=<?php echo $row->id;?>"><?php echo $row->hastatckimlik;?></a></td>
